...
class TrainerEngine:
    ...
    def run_epoch(self, loader, optimizer=None):
        ...
        with context:
            for inputs_batch, targets_batch, ids_batch in loader:
                ...
                for ds_id in unique_ids:
                    ...
                    ds_loss = sum(self.loss_fn.step(logits, t) for t in ds_targets)
        ...
        final_losses = {
            name: (epoch_losses[name] / epoch_samples[name]) 
...
class TrainingReporter:
    @staticmethod
    def print_epoch(epoch, total_epochs, train_metrics: EpochMetrics, val_metrics: EpochMetrics, loss_fn, metrics_list, weighted_metrics):
...
def run_phase(model, train_loader, val_loaders, epochs, optimizer, scheduler, loss_fn, weights, dataset_names, metrics, patience, device):
    ...
    for epoch in range(1, epochs + 1):
        ...
        TrainingReporter.print_epoch(
            ...
            loss_fn, metrics, global_metrics
        )
